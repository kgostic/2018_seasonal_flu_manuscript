...
H1N1.model.dat$country[which(H1N1.model.dat$country %in% c('Austria', 'Portugal'))] = 'Other'
...
nrow(H1N1.model.dat)
test.inds = sample(1:nrow(H1N1.model.dat), size = 1000, replace = FALSE)
...
# Split into training and test data
nrow(H3N2.model.dat)
test.inds = sample(1:nrow(H3N2.model.dat), size = 1000, replace = FALSE)
...
fit1 = glm(infected ~ anyav + anydx + country + age + H3.valid*season + H3.valid*anyvac, data = train, family = binomial)
summary(fit1)


## H1N1 fit to age plus imprinting, plus fixed effects of vaccination, av use, underlying conditions, country and season
fit2 = glm(infected ~ anyav + anydx + country + age + imp.status + H3.valid*season + H3.valid*anyvac, data = train, family = binomial)
summary(fit2)
