...
## 8. TU
lk.TU = nll.wrapper(pars.in = c('rAV' = .5, 'rDX' = .5), pro.H1 = 1, pro.H3 = 1, lower.in = c(av.low, dx.low, vx.low, vx.low), upper = c(av.high, dx.high)); lk.TU
...
## 16. UT
lk.UT = nll.wrapper(pars.in = c('rDX' = .5, 'rVX.H1' = .5, 'rVX.H3' = .5), pro.H1 = 1, pro.H3 = 1, lower.in = c(dx.low, vx.low, vx.low), upper = c(dx.high, vx.high, vx.high)); lk.UT
