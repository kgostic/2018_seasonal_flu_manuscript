...
pdf(outfile)
## Set the layout
layout(mat = matrix(c(0,0,0,1,1,1, 9,9,3,3,6,6, 2,2,4,4,7,7, 10,10,5,5,8,8)+1, nrow = 4,  byrow = T), heights = c(1.5, 1,1,1))
#layout.show(10)
...
# 
# ## Section header
# polygon(x = c(0,0,10,10), y = c(0,1,1,0), col = 'gray80', xpd = NA, border = NA)
# text(5, .5, 'Age-specific risk', xpd = NA, font = 2, cex = 1.2)
# text(5, -.5, '(Hypothetical)', xpd = NA)
# 
# 
# plot.new()
# plot.window(xlim = c(0,10), ylim = c(0,1))
# ## Section header
# polygon(x = c(0,0,10,10), y = c(0,1,1,0), col = 'gray80', xpd = NA, border = NA)
# text(5, .5, 'Birth year-specific risk', xpd = NA, font = 2, cex = 1.2)
# text(5, -.5, '(From imprinting reconstructions)', xpd = NA)
# 
# plot.new()
# plot.window(xlim = c(0,10), ylim = c(0,1))
# ## Section header
# polygon(x = c(0,0,10,10), y = c(0,1,1,0), col = 'gray80', xpd = NA, border = NA)
# text(5, .5, 'Model predictions', xpd = NA, font = 2, cex = 1.2)
# text(5, -.5, '(Hypothetical)', xpd = NA)
