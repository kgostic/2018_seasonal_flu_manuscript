...
text(x = 2, y = 4.5, ("Later, exposed to"), font = 2, xpd = NA)
polygon(x = c(3,3,6,6), y = c(4.2,4.8,4.8,4.2), col = ('dodgerblue'))
text(x = 4.5, y = 5.5-1, 'H1N1', font = 2)
polygon(x = c(3,3,6,6)+3, y = c(4.2,4.8,4.8,4.2), col = ('firebrick'))
text(x = 4.5+3, y = 5.5-1, 'H3N2', font = 2)
...
text(x = 6.5, y = y.imp, 'H1N1', font = 1)
text(x = 7.5, y = y.imp, 'H2N2', font = 1)
text(x = 8.5, y = y.imp, 'H3N2', font = 1)


## Assume imprinting acts at the...
text(x = 2, y = 3.5, "Protection breadth:", xpd = NA)
