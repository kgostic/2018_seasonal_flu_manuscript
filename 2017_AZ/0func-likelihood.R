...
nll = function(pars, wPro.H1, dat.H1, wPro.H3, dat.H3, a0.4, a5.10, a11.17, a18.24, a25.31, a32.38, a39.45, a46.52, a53.59, a60.66, a67.73, a74.80, a81.90plus, dem){
  ...
  age.baseline = dem*b*(a0.4 +         # = demography * baseline age-specific risk * relative risk in age class
                      r5.10*a5.10 +
                      r11.17*a11.17+
                      r18.24*a18.24+
                      r25.31*a25.31+
                      ...
                      r74.80*a74.80+ 
                      r81.90p*a81.90plus)
  age.baseline = age.baseline/rowSums(age.baseline) # Normalize so that the fraction of cases predicted in each age group sums to 1. Then interpret age.baseline as expected fraction of cases occurring in a given age/birth year, in the absence of imprinting effects.
  
  
  # 2. Add imprinting effects and calculate predicted distribution, pp, as a function of the parameters:
  ...
  ## H1N1 contribution to the likelihood
...
nll.wrapper = function(pars.in, pro.H1, pro.H3, lower.in, upper.in){
  ...
  optim(par = pvec, fn = nll, wPro.H1 = pro.H1, wPro.H3 = pro.H3, a0.4 = a0.4, a5.10 = a5.10, a11.17 = a11.17, a18.24 = a18.24, a25.31 = a25.31, a32.38 = a32.38, a39.45 = a39.45, a46.52 = a46.52, a53.59 = a53.59, a60.66 = a60.66, a67.73 = a67.73, a74.80 = a74.80, a81.90plus = a81.90plus, dat.H1 = H1.master, dat.H3 = H3.master, dem = demog, method = 'L-BFGS-B', lower = c(lower.in, rep(.001, 12)), upper = c(upper.in, rep(5, 12)))
...
profile_func = function(pars, fixed.par.name, fixed.par.value, wPro.H1, dat.H1, wPro.H3, dat.H3, a0.4, a5.10, a11.17, a18.24, a25.31, a32.38, a39.45, a46.52, a53.59, a60.66, a67.73, a74.80, a81.90plus, dem){
