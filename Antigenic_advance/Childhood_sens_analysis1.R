## GENERATE AN ALTERNATE VERSION OF FIG. 4A USING AGES 2-10 TO DEFINE CHILDREN
...
ggsave(filename = '../figures/Antigenic_advance_corplot_2child10.tiff', height = 3, width = 7)
